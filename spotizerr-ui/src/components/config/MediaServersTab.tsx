    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-content-muted dark:text-content-muted-dark mt-1">Consider using the built-in functions for a scheduled scan in jellyfin/plex</p>
        </div>
